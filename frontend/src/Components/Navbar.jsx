...
const Navbar = () => {
    ...
    if (location.pathname === "/login" || location.pathname === "/moderator/voting" || location.pathname === "/admin") return null;
    ...
    return (
        <div className="fixed top-0 w-screen h-[60px] bg-white flex items-center justify-between px-4 py-2
            ...
            <Link to="/" style={{ textDecoration: "none" }}>
                <div className="font-rabar font-bold text-2xl text-black text-right 1.5xl:mr-3 cursor-pointer">
                    وشەسازی
                </div>
            </Link>
        </div>
